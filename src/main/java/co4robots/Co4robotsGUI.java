...
import co4robots.engine.EventSelectionValidator;
import co4robots.engine.EventStorage;
import co4robots.engine.PSPController;
import co4robots.gui.dialogs.EditEventDialog;
import co4robots.gui.dialogs.NewEventDialog;
import co4robots.mappings.LTLMapper;
import co4robots.mappings.MTLMapper;
import co4robots.mappings.PatternMapper;
import co4robots.mappings.PrismMapper;
import co4robots.mappings.QuantitativePrismMapper;
import co4robots.mappings.SELMapper;
...
public class Co4robotsGUI extends javax.swing.JFrame implements PSPController
{
    ...
    private void initComponents() {
        ...
        fScopes = new co4robots.gui.panels.scopes.ScopePanel();
        fScopes.setBackground(BACKGROUNDCOLOR);
        
        patternJPanel = new javax.swing.JPanel();
        fPatterns = new co4robots.gui.panels.pattern.PatternPanel();
    ...
    private co4robots.gui.panels.pattern.PatternPanel fPatterns;
    private javax.swing.JTextPane fSELP;
    private javax.swing.JButton fSEs;
    private co4robots.gui.panels.scopes.ScopePanel fScopes;
