...
public class PastAvoidance extends Movements
{
    public PastAvoidance()
    {
        this( Event.getDefault(), null, null );
    }
    
    public PastAvoidance( Event aEventP, TimeBound aTimeBound, ProbabilityBound aProbBound )
    {
    ...
    public int getType() 
    {
        return PSPConstants.P_PastAvoidance;
    }
