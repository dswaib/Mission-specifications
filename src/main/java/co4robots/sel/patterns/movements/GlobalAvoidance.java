...
package co4robots.sel.patterns.movements;
...
import co4robots.sel.patterns.Movements;
import co4robots.sel.patterns.Occurrence;

public class GlobalAvoidance extends Movements
{
    public GlobalAvoidance()
    {
        this( Event.getDefault(), null, null );
    }
    
    public GlobalAvoidance( Event aEventP, TimeBound aTimeBound, ProbabilityBound aProbBound )
    {
    ...
    public int getType() 
    {
        return PSPConstants.P_GlobalAvoidance;
    }
