...
public class FutureAvoidance extends Movements
{
    public FutureAvoidance()
    {
        this( Event.getDefault(), null, null );
    }
    
    public FutureAvoidance( Event aEventP, TimeBound aTimeBound, ProbabilityBound aProbBound )
    {
    ...
    public int getType() 
    {
        return PSPConstants.P_FutureAvoidance;
    }
