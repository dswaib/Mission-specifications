...
import co4robots.sel.patterns.order.PrecedenceChain1N;
...
public class PrecedenceChain1NPanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    ...
    private void initComponents() {
        ...
        fS1 = new co4robots.gui.util.EventComboBox();
        ...
        fS2 = new co4robots.gui.util.EventComboBox();
        fLabel7 = new javax.swing.JLabel();
        fZS = new co4robots.gui.util.ContraintComboBox();
    ...
    private co4robots.gui.util.EventComboBox fS1;
    private co4robots.gui.util.EventComboBox fS2;
    ...
    private co4robots.gui.util.ContraintComboBox fZS;
