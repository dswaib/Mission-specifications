...
import co4robots.gui.dialogs.UpperTimeBoundDialog;
...
public class PrecedenceChainEventPanel extends javax.swing.JPanel implements ChainEventPanelFeatures
{
    ...
    private void initComponents() {
        ...
        fTi = new co4robots.gui.util.EventComboBox();
        fZi = new co4robots.gui.util.ContraintComboBox();
    ...
    private co4robots.gui.util.EventComboBox fTi;
    private javax.swing.JButton fTimeBoundButton;
    private co4robots.gui.util.ContraintComboBox fZi;
