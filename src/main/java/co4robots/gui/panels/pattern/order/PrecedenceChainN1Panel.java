...
package co4robots.gui.panels.pattern.order;

import co4robots.constraints.EventConstraint;
import co4robots.constraints.ProbabilityBound;
import co4robots.constraints.TimeBound;
import co4robots.engine.PSPController;
import co4robots.gui.dialogs.IntervalTimeBoundDialog;
...
import co4robots.sel.patterns.order.ChainEvents;
import co4robots.sel.patterns.order.PrecedenceChainN1;
...
public class PrecedenceChainN1Panel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    ...
    private void initComponents() {
        ...
        fP1 = new co4robots.gui.util.EventComboBox();
        fTiLabel = new javax.swing.JLabel();
        fTi = new co4robots.gui.panels.pattern.order.chains.PrecedenceChainEventSequencePanel();
        fLabel4 = new javax.swing.JLabel();
        fS = new co4robots.gui.util.EventComboBox();
        fTimeBound = new javax.swing.JButton();
        fProbabilityBound = new javax.swing.JButton();
        fLabel6 = new javax.swing.JLabel();
        fP2 = new co4robots.gui.util.EventComboBox();
        fLabel7 = new javax.swing.JLabel();
        fZP = new co4robots.gui.util.ContraintComboBox();
    ...
    private co4robots.gui.util.EventComboBox fP1;
    private co4robots.gui.util.EventComboBox fP2;
    private javax.swing.JButton fProbabilityBound;
    private co4robots.gui.util.EventComboBox fS;
    private co4robots.gui.panels.pattern.order.chains.PrecedenceChainEventSequencePanel fTi;
    private javax.swing.JLabel fTiLabel;
    private javax.swing.JButton fTimeBound;
    private co4robots.gui.util.ContraintComboBox fZP;
