...
public class ScrollableGlobalAvoidancePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private GlobalAvoidancePanel fPatternPanel;

    public ScrollableGlobalAvoidancePanel()
    {
        fPatternPanel = new GlobalAvoidancePanel();
