...
import co4robots.gui.panels.pattern.order.ChainChanged;
import co4robots.sel.patterns.Pattern;
import co4robots.sel.patterns.order.ChainEvents;

public class ScrollableFutureAvoidancePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private FutureAvoidancePanel fPatternPanel;

    public ScrollableFutureAvoidancePanel()
    {
        fPatternPanel = new FutureAvoidancePanel();
