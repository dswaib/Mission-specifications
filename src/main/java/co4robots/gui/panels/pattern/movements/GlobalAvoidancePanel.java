...
public class GlobalAvoidancePanel extends javax.swing.JPanel implements PatternPanelFeatures
{
    /**
	 * 
	 */
    ...
    private GlobalAvoidance fSelectedPattern;
    ...
    {
        if ( aSelectedPattern instanceof GlobalAvoidance )
        {
            fSelectedPattern = (GlobalAvoidance)aSelectedPattern;
    ...
    public GlobalAvoidancePanel() 
    {
        initComponents();
        this.setBackground(Co4robotsGUI.BACKGROUNDCOLOR);
        fSelectedPattern = new GlobalAvoidance();
    }

    public void clearSelection()
    {
        setSelectedPattern( new GlobalAvoidance() );
    }
