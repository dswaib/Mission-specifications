...
public class FutureAvoidancePanel extends javax.swing.JPanel implements PatternPanelFeatures
{
    /**
	 * 
	 */
    ...
    private FutureAvoidance fSelectedPattern;
    ...
    {
        if ( aSelectedPattern instanceof FutureAvoidance )
        {
            fSelectedPattern = (FutureAvoidance)aSelectedPattern;
    ...
    public FutureAvoidancePanel() 
    {
        initComponents();
        this.setBackground(Co4robotsGUI.BACKGROUNDCOLOR);
        fSelectedPattern = new FutureAvoidance();
    }

    public void clearSelection()
    {
        setSelectedPattern( new FutureAvoidance() );
    }
