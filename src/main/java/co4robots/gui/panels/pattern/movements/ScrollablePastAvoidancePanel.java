...
public class ScrollablePastAvoidancePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private PastAvoidancePanel fPatternPanel;

    public ScrollablePastAvoidancePanel()
    {
        fPatternPanel = new PastAvoidancePanel();
