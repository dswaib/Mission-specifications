...
import co4robots.constraints.Interval;
import co4robots.constraints.LowerTimeBound;
import co4robots.constraints.TimeBound;
import co4robots.constraints.UpperTimeBound;
...
{   
    ...
    private void initComponents() {
        ...
        fUpperInterval = new co4robots.gui.util.TimeTextField();
        fUpperTime = new co4robots.gui.util.TimeTextField();
        fLowerTime = new co4robots.gui.util.TimeTextField();
        fLowerInterval = new co4robots.gui.util.TimeTextField();
    ...
    private co4robots.gui.util.TimeTextField fLowerInterval;
    private javax.swing.JRadioButton fLowerLimit;
    private co4robots.gui.util.TimeTextField fLowerTime;
    ...
    private co4robots.gui.util.TimeTextField fUpperInterval;
    private javax.swing.JRadioButton fUpperLimit;
    private co4robots.gui.util.TimeTextField fUpperTime;
